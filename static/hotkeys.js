...
export const HOTKEY_DEFS = [
  ...
  { id: "undo", label: "撤销" },
  { id: "redo", label: "重做" },
  { id: "hideLabeled", label: "开启 / 关闭隐藏已标叶片" },
  { id: "rememberView", label: "开启 / 关闭视角保留" },
  { id: "panUp", label: "视角上移" },
...
export const DEFAULT_HOTKEYS = {
  ...
  hideLabeled: { code: "KeyZ", key: "z", ctrl: false, shift: false, alt: false },
  rememberView: { code: "KeyX", key: "x", ctrl: false, shift: false, alt: false },
